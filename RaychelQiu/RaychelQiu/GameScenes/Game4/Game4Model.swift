...
extension Round {
    static let rounds = [
        ...
        Round(round: 2, image: "Game4_Round2", size: 350, x: 0, y: 0, startPosition: .init(x: 120, y: 320), targetPosition: [.init(x: 60, y: 220), .init(x: 100, y: 120), .init(x: 200, y: 70), .init(x: 300, y: 120), .init(x: 330, y: 220), .init(x: 280, y: 320)], success: [false, false, false, false, false, false], result: "Game4_2", chevron: -140),
