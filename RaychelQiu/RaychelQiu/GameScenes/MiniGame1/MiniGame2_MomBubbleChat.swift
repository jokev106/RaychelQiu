...
struct MiniGame2_MomBubbleChat: View {
    ...
    //Position items
    @State var positionTextBox_1 = CGPoint(x: 295, y: 208)
    @State var positionTextBox_2 = CGPoint(x: 290, y: 208)
    @State var positionTextBox_3 = CGPoint(x: 253, y: 184)
    @State var positionTextBox_4 = CGPoint(x: 267, y: 184)
    @State var positionTextBox_5 = CGPoint(x: 295, y: 227)
    @State var positionRaychelAnger = CGPoint(x: 198, y: 350)
    ...
    @State var heartBrokenMax: String? = nil
